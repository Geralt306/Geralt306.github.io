...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by msa %c 你正在访问msaの小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| msa") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('msa的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  var start = new Date("08/22/2023 00:00:00"); // 旅行者1号开始计算的时间
  ...
  (currentTimeHtml =
    hnum < 18 && hnum >= 9
      ? `<img class='boardsign' src='https://pic.msaer.cn/img/F%E5%B0%8F%E5%B1%8B-%E4%B8%8B%E7%8F%AD%E4%BC%91%E6%81%AF%E5%95%A6.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`
      : `<img class='boardsign' src='https://pic.msaer.cn/img/F%E5%B0%8F%E5%B1%8B-%E4%B8%8B%E7%8F%AD%E4%BC%91%E6%81%AF%E5%95%A6.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${dis} 千米，约为 ${unit} 个天文单位 🚀</div>`),
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://s2.loli.net/2023/08/23/xjoTpXVD7QCF24H.webp);
    --darkmode-bg:url(https://s2.loli.net/2023/08/23/FfyjB5LbSldVhJ8.webp);
    --mobileday-bg: url(https://s2.loli.net/2023/08/23/LsUDoA1PwVh7GMI.webp);
    --mobilenight-bg: url(https://s2.loli.net/2023/08/23/BPVxKqoNcTOnhtl.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
function createWinbox() {
  ...
  // 每一类我放了一个演示，直接往下复制粘贴 a标签 就可以，需要注意的是 函数里面的链接 冒号前面需要添加反斜杠\进行转义  美化模块主体DOM(<h3>1. 二次元</h3>
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/08/23/Hc5n4xfj8kSozXy.webp)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/08/23/Hc5n4xfj8kSozXy.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/08/23/a9Eb5P6xdFM2SLr.webp)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/08/23/a9Eb5P6xdFM2SLr.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/08/23/esSa3Vmg4dkptKR.webp)" class="imgbox" onclick="changeBg('url(https://s2.loli.net/2023/08/23/esSa3Vmg4dkptKR.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://s2.loli.net/2023/08/23/gcNsHlRrL3PtEIu.webp)" class="pimgbox" onclick="changeBg('url(https://s2.loli.net/2023/08/23/gcNsHlRrL3PtEIu.webp)')"></a></div>
              </div>
            </details>
